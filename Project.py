...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Project Docs\\Lab In Psychology\\Project.py',
...
for thisTrial in trials:
    ...
    trials.addData('size_match', size_match)
...
for thisTrial_4 in trials_4:
    ...
    trials_4.addData('cue_match', cue_match)
